			...
			<form action="{{route('project.store')}}" method="POST">
				...
				<div class="modal-body">
					<div class="row g-3 align-items-center">
					  ...
					  <div class="col-7">
						<input type="number" id="number_of_groups" name="number_of_groups" class="form-control @error('number_of_groups') is-invalid @enderror" value="{{ old('number_of_groups') }}">
				...
				<div class="modal-body">
					<div class="row g-3 align-items-center">
					  ...
					  <div class="col-7">
						<input type="number" id="max_number_students_in_group" name="max_number_students_in_group" class="form-control @error('max_number_students_in_group') is-invalid @enderror" value="{{ old('max_number_students_in_group') }}">
